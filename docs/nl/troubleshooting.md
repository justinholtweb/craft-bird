...
order: 40
summary: Wat de gebruikelijke storingen betekenen en wat je eraan doet.
---

Begin met `php craft bird/sync/status`. Dat meldt de verbinding, de editie, of de plugin zichzelf
...
3. **De trigger past niet.** *De bestelling is betaald* reageert op het paid-event van Commerce. Als
   je provider de bestelling afrondt zonder hem op betaald te zetten, gebruik dan *afgerond* of een
   status.
...
Zodra een document geen pogingen meer heeft, negeert retry het en moet je bij de bestelling op
...
Heb je de aansluiting uitgezet, dan weigert Bird die bestellingen in plaats daarvan, met het
verschil in de foutmelding. Dat is de instelling die doet wat hij zegt.

## Een bestelling met een btw-nummer is op 21% geboekt

Dat klopt, en het is de meest voorkomende verrassing in de plugin.

Verlegging is een uitspraak over wat er *berekend is*. Als de bestelling 21% betaalde, was het geen
verlegging, wat het adres ook zegt — en het als verlegd boeken zou je aangifte precies verlagen met
wat de klant betaald heeft. Wat je ziet is een webshop met de btw-nummercontrole van Commerce uit.
...
aangemaakt wordt, en de unieke index op `(orderId, kind, sourceKey)` zit daarachter. Zie je twee
