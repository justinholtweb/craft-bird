...
slug: faq
order: 50
summary: De vragen die het waard zijn beantwoord te worden vóór je installeert.
---

## Is Bird gelieerd aan Moneybird?

Nee. Bird is een onafhankelijke plugin, gebouwd door Justin Holt. De plugin is niet gelieerd aan
...
Komen je facturen uit Moneybird, dan wil je **verkoopfacturen**: Moneybird nummert ze, maakt de pdf
en kan ze mailen.

Geeft je webshop zijn eigen facturen al uit en moet alleen de boekhouding kloppen, dan wil je
**externe verkoopfacturen**: de bestelreferentie is het factuurnummer en Moneybird boekt alleen de
omzet en de btw.
...
Nee, en dat is het ontwerp. De belastingmotor van Commerce kent je zones, je tarieven en je
btw-nummercontroles al. Dat hier opnieuw afleiden zou je webshop twee antwoorden geven die
...
rubrieken van een btw-aangifte terechtkomen.
...
over wat er berekend had kunnen worden — en het als verlegd boeken zou je btw-aangifte precies
...
Nee. Alles wat tijdens het afrekenen draait faalt open — de triggers slikken hun eigen fouten in, en
de push loopt standaard via de wachtrij. Een storing bij Moneybird, een verlopen token of een
...
Nee. De documententabel is uniek op `(bestelling, soort, bron)`, en die index is de garantie — een
...
Niets, tot je erom vraagt. `bird/sync/backfill` haalt ze alsnog op, en `--dry-run` meldt elke
bestelling die geboekt zou worden, onder welke btw-behandeling, zonder iets te versturen.

## Heb ik de webhook nodig?

Alleen als facturen ergens anders betaald worden dan bij je checkout. Bird stuurt facturen; Moneybird
is waar een overschrijving eraan gekoppeld wordt. Zonder de webhook is het idee van je site over
"betaald" wat de betaalprovider bij het afrekenen zei. Mét de webhook vertelt Moneybird het je — over
...
Commerce rondt de btw per regel af op de cent, dus de som van de regels kan een cent afwijken van het
bestellingstotaal. Het factuurtotaal moet gelijk zijn aan wat de klant betaald heeft, want dat is wat
de bankkoppeling toont — dus het verschil wordt geboekt als een regel van 0%. Een cent
btw-afrondingsverschil is geen omzet en hoort niet belast te worden alsof het dat wel is.

Hoor je liever van die bestellingen dan dat ze aangesloten worden, zet **Totalen aansluiten** dan uit;
Bird weigert ze dan.

## Kan ik het met meerdere Moneybird-administraties gebruiken?

Eén administratie per Craft-installatie. Draai je meerdere webshops in één installatie die naar
